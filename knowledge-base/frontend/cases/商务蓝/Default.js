...
class Default extends React.PureComponent<any, any> {
  ...
  render() {
    ...
    if (mailMenuKeys.includes(data.menuKey)) { // 邮箱类
      ...
      return (
        <div className={'app-737142488378564608-toolbar-item app-737142488378564608-toolbar-default-item'} title={data.i18nCustomMenuName || data.i18nMenuName || ''} onClick={this.onClick}>
