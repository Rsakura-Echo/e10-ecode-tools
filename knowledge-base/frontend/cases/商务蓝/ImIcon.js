...
class ImIcon extends React.PureComponent {
  ...
  render() {
    ...
    const className = 'app-737142488378564608-toolbar-item app-737142488378564608-im';
    const openClassName = 'app-737142488378564608-toolbar-item-open app-737142488378564608-im-open';
    const popupClassName = 'app-737142488378564608-trigger-popup app-737142488378564608-im-popup';
    ...
    return (
      ...
      >
        <div className={`${className} ${popupVisible ? openClassName : ''}`} title={getLabel('62238', '消息')} onClick={this.showImContent}>
          {imCounter !== 0 && <div className="app-737142488378564608-im-counter">{imCounter}</div>}
