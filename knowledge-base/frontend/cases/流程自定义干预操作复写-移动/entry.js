...
const CustomInterventionComForEM = React.lazy(() => asyncImport('${appId}', 'customInterventionCom'));

//复写组件内容
regOvComponent('weappWorkflow', 'MWfcCustomOperateContent', (Com) => {
    return React.forwardRef((props, ref) => {
      //wffpOperCustomStore
        ...
        console.log("MWfcCustomOperateContent_props",props);
        //详情框架显示意见输入框改写
        if(actionType == 'INTERVENTION'){
          ...
          return (
            <>
              <CustomInterventionComForEM {...props} {...params} />
              <Com ref={ ref } {...props} />
            </>
          )
        }
