...
import { cs, pick, useMergeProps, isFunction } from './utils';
import { asyncImport } from '@weapp/ecodesdk';

const TriggerAsync = React.lazy(() => asyncImport('759462359534247936', 'index'));

// 触发器所需要的事件
const EventsByTriggerNeed = [
  'onClick', 'onMouseEnter', 'onMouseLeave', 'onMouseMove',
  'onFocus', 'onBlur', 'onContextMenu', 'onKeyDown'
];
...
function Tooltip(baseProps: PropsWithChildren<TooltipProps>, ref) {
  ...
  const componentConfig = undefined;
